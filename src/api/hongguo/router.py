...
def _task_to_response(task) -> TaskResponse:
    ...
    return TaskResponse(
        ...
        random_like_count=task.random_like_count if task.random_like_count is not None else 5,
        random_favorite_count=task.random_favorite_count if task.random_favorite_count is not None else 1,
        ...
        likes_completed=task.likes_completed or 0,
        favorites_completed=task.favorites_completed or 0,
        completion_screenshot_path=task.completion_screenshot_path,
