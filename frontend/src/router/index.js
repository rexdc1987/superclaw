...
const routes = [
  ...
  },
  {
    ...
    meta: { title: '创建红果任务', icon: 'VideoPlay' }
  },
  {
    path: '/hongguo/task/:id',
    name: 'HongguoExecute',
    component: () => import('@/views/TaskExecute.vue'),
    meta: { title: '红果任务执行', icon: 'VideoPlay' }
  },
  {
    path: '/hongguo/templates',
    name: 'HongguoTemplates',
    component: () => import('@/views/TemplateManager.vue'),
    meta: { title: '红果模板', icon: 'Document' }
  },
  {
